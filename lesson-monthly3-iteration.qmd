...
There are no "on your own" parts to this lesson, but if you want to follow along on your own computer and play with the code, download this <i class="bi bi-download"></i> [practice copy](practice-monthly3-iteration.qmd){download="practice-monthly3-iteration.qmd"} and save it in your chj23 project.

If you want a clean copy of the lesson to save for reference, download the <i class="bi bi-download"></i> [ lesson version](lesson-monthly3-iteration.qmd){download="lesson-monthly3-iteration.qmd"} which is this file you are reading. They are essentially the same but with different file names.
