...
- [`mutate()`](https://dplyr.tidyverse.org/reference/mutate.html) changes an existing column or creates a new one. **Example:** `mutate(new_col = (col01 / col02))`.
